...
/* Было тяжко, но я справился. Чуть не сдался,
   но как оказалось задачи в практикуме дают ровно то, что нужно для итогового задания, не меньше.
   Честно говоря всё ещё стоит несколько раз перечитать, потому что сделать сделал, но с кряхтением.
 */